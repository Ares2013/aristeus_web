! function() {
	...
	h.widgetId.get = function() {
		...
		var l, d = isNaN(this.settings.height) ? this.settings.height : this.settings.height + "px",
		...
		this.settings.utm_source = location.hostname, this.settings.utm_medium = h ? "widget_new" : "widget", this.settings.utm_campaign = this.widgetUtmName, this.iframe = this._createIframe(u, p, n, r, a.id);
		...
		return i.widgetId.get = function() {
			...
			return ["colorTheme", "currencies", "disableCrossClickHref", "height", "isTransparent", "largeChartUrl", "locale", "whitelabel", "width"]
